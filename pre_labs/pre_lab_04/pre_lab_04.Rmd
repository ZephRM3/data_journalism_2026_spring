...
There are a lot of doubles in the grantee column that shouldn't be there. Most of these are just the same entity but have something like "inc" or "llc" tagged on. 
...
Uppercased Washington County Museum of Fine Arts, and Mount St Marys University. 
...
Lowercased Washington Adventist University, Washington College, and Washington County Commission on Aging.

```{r}
w_grantees <- cleaned_md_grant_loans |>
...
From what I see the changes are not huge from data set to dataset based on this change.
