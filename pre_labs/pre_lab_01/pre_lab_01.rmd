...
The first line designates the data set of Maryland churches. Inside the pipe character is code that isolates all the towns in Maryland, and then counts the number of churches each town has.
...
It sorted the count function by largest to smallest, allowing us to see what towns have the most churhces. 
...
The previous codeblock is the head (or the first six rows of the megachurch dataset), it gives all the variables, but only the first six and it is unorganized. The second codeblocl organizes, counts, and then arragnes the data to show church denominations and there size from largest to smallest which is much more useful data.
...
1.  What is the biggest congregation in Maryland? The same piece of code that was run for the megachurches right at the end.

2.  What church or churches in Maryland have the highest income/assets?

3.  How many megachurches ar in Maryland? 
