...
There is cleanup to do to the values and also cleanup to do to the value types. Some columns that are meant to represent numbers are characters for instance. There are also two sets of data, the US as a whole and states are in the same row.
...
as.numeric is converting some character values into NAs. There are still weird elipses in the state columns
...
Still have to get rid of excess periors in the states. There is also a random "3" in Florida and other stuff like that. 
